...
var info = {
    "rules": `
        一、兑换码有效期</br>
        （1）原则上兑奖码有效期为2018年1月31日至12月31日，但由于礼品数量有限，建议尽快在平台中进行兑换。</br>
        二、参加资格</br>
        （1）从渣打银行官方渠道的实体卡片、SMS等获得礼品兑换码，即可登入平台进行兑换；以下简称“持码客户”。</br>
        （2）持码客户或非持码客户如有下述任一情形：利用网络延迟或系统漏洞进行重复兑换的、擅自猜测礼品兑奖码并成功进行兑换的、从非官方渠道获得兑换码进行兑换的等各类违法违规情况者，我们有权利向渣打银行汇报相关情况，并由渣打银行决定是否追究其法律责任和赔偿因此造成的损失，包括经济和名誉损失等。</br>
        三、兑换码适用范围</br>
        （1）本兑换码只适用于兑换指定渠道的特定礼品，相关可兑换礼品请登入H5礼品兑换平台查看，不适用于任何其他渠道和平台。</br>
        四、礼品兑换流程</br>
        （1）实体卡：从官方渠道获得实体卡后，根据卡片背面说明进行操作兑换。</br>
        （2）SMS：从官方渠道获得短信或微信推送信息等后，点击链接或扫描二维码登入H5平台进行兑换。</br>
        五、兑换码的说明</br>
        （1）兑换码具有唯一性，一个兑换码只能兑换对应的一个奖品，重复或多次兑换无效。</br>
        （2）请妥善保管您的礼品兑换码，兑换码不记名、不挂失、不补办、不可兑现或抵扣、不提供发票，并请在有效期内使用。</br>
        （3）请不要轻易转让或透露您的兑奖码，因此造成兑换码失效而无法兑换礼品的情况，需持码客户自行承担。</br>
        六、关于礼品</br>
        （1）礼品由渣打银行委托我司进行第三方采购及配送，若因第三方提供的礼品缺货或停产，我们会在H5平台的公告栏中发布相关公告信息，持码客户可在平台中选择并兑换其他可选礼品，若所有礼品均无法选择请及时与我们取得联系，我们会与渣打银行相关部门协商更换其他礼品，并及时公示提醒大家。</br>
        （2）所兑礼品以收到的实物为准，平台照片为示意图，仅供参考。
        七、关于配送</br>
        （1）持码客户在平台成功兑换礼品后，我们会及时安排发货，送货时效一般为9个工作日，其中2个工作日为订单处理，配送时效为7个工作日，遇周末或节假日时效将顺延，偏远地区以最终实际配送时间为准，尽请谅解。</br>
        八、隐私保护</br>
        （1）请确保您在平台中所登记的信息真实且有效，以便于工作人员可以及时与您取得联系，处理礼品发放中遇到的紧急情况。当然，我们会保护好您的个人隐私安全，未经您的授权或许可我们不会给任何与本活动无关的第三方相关信息。</br>
        九、咨询与服务</br>
        （1）我们的热线电话是021-60377599，接待时间为工作日的10:00-17:00。</br>
        十、解释权</br>
        （1）最终解释权归渣打银行授权的本次活动供应商【上海沃德达彼思广告有限公司】所有。</br>
    `
};
